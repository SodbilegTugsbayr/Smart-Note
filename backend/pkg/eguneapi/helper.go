...
5. **quizzes** — Материалын ойлголтыг шалгах 10 олон сонголттой тест асуулт бэлтгэнэ үү; дөрвөн хувилбар (options) өгч, correct_answer нь options-ийн аль нэгтэй яг таарах ёстой
